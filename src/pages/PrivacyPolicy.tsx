      ...
      <div className="container">
        <div className="row">
          <div className="col-12 py-3 ">
            <div style={{ fontSize: 15, marginTop: 50 }}>
              <p>
                We, HOMENTOR Registered under the Provisions of the Companies
                Act 1956, having its registered office at “S.N. ARCADE, VIJAY
                NAGAR, INDORE, M.P. ,452010, INDIA” hereinafter referred to as
                the “Company” (where such expression shall, unless repugnant to
              ...
              <p>
                ...
                www.homentor.in (hereinafter referred to as the “Platform”).
              </p>
              ...
              <p>
                ...
                Protection Regulation (GDPR) in effect from January, 2024, and
              ...
              <p>
                1. HEREIN ARE ONLY FOR THE PURPOSE OF ARRANGING THE VARIOUS
              ...
              <p>
                .1.a. “We”, “Our”, and “Us” shall mean and refer to the Domain
                and/or the Company HOMENTOR EDU (OPC) PRIVATE LIMITED, as the context so requires.{" "}
              </p>
              <p>
                1.1.b. “You”, “Your”, “Yourself”, “User”, shall mean and refer
                to natural and legal individuals who use the Platform and who
                are competent to enter into binding contracts, as per Indian
                laws.{" "}
              </p>
              <p>
                1.1.c. “Services” shall refer to Services provided by the
                Company HOMENTOR EDU (OPC) PRIVATE LIMITED, for users of the platform to host their own online
                courses and earn a royalty for each sale the users can access
                the content through videos, texts, and slides The detailed
                explanation shall be provided in Clause 3 of Terms of Use.{" "}
              </p>
              <p>
                1.1.d. “Third Parties” refer to any Application, company or
                individual apart from the User, Vendor and the creator of this
                Application.{" "}
              </p>
              <p>
                1.1.e. The term “Platform” refers to the Website/Domain created
                by the Company HOMENTOR EDU (OPC) PRIVATE LIMITED which provides the Client to avail services of
                the Company thru the use of the platform.{" "}
              </p>
              <p>
                1.1.f. The term “User” refers to the individuals who will be
                using the platform to post their teachings and the individuals
                who are using the platform to learn from the videos that have
                been uploaded.{" "}
              </p>
              <p>
                1.1.g. “Personal Information” shall mean and refer to any
                personally identifiable information that We may collect from You
                such as Name, Email Id, Mobile number, Password etc. For removal
                of any doubts, please refer to Clause{" "}
              </p>
              <p>
                <strong>2. INFORMATION WE COLLECT</strong>
              </p>
              <p>
                2.1 We are committed to respecting Your online privacy. We
                further recognize Your need for appropriate protection and
                management of any Personal Information You share with us. We may
                collect the following information:{" "}
              </p>
              <p>
                2.2. Personal data such as, but not limited to, Name, Email Id,
                Mobile number, Password, Age, Address, etc ;{" "}
              </p>
              <p>
                2.3. Tracking Information such as, but not limited to the IP
                address of your device and Device ID when connected to the
                Internet. This information may include the URL that you just
                came from (whether this URL is on the Platform or not), which
                URL you next go to (whether this URL is on the Platform or not),
                your computer or device browser information, and other
                information associated with your interaction with the Platform;{" "}
              </p>
              <p>2.4. Details of Platform usage for analytics.</p>
              <p>
                This privacy policy also applies to data we collect from users
                who are not registered as members of this Platform, including,
                but not limited to, browsing behaviour, pages viewed etc. We
                also collect and store personal information provided by You from
                time to time on the Platform. We only collect and use such
                information from you that we consider necessary for achieving a
                seamless, efficient and safe experience, customized to your
                needs including:
              </p>
              <p>
                2.4.a. To enable the provision of services opted for by you;
              </p>
              <p>2.4.b. To enable the viewing of content in your interest; </p>
              <p>
                2.4.c. To communicate the necessary account and service related
                information from time to time;{" "}
              </p>
              <p>
                2.4.d. To allow you to receive quality customer care services
                and data Collection;{" "}
              </p>
              <p>
                2.4.e. To comply with applicable laws, rules and regulations;{" "}
              </p>
              <p>
                Where any service requested by You involves a third party, such
                information as is reasonably necessary by the Company HOMENTOR EDU (OPC) PRIVATE LIMITED to carry
                ...
                your interests and prior activity and also to view the content
                preferred by you. The Company may also use contact information
                internally to direct its efforts for service improvement but
                shall immediately delete all such information upon withdrawal of
                your consent for the same through the ‘unsubscribe’ button or
                through an email to be sent homentorindia@gmail.com{" "}
              </p>
              <p>
              ...
              <p>
                3. OUR USE OF YOUR INFORMATION The information provided by you
                shall be used to provide and improve the service for you and all
                users.{" "}
              </p>
              <p>3.1. For maintaining an internal record.</p>
              <p>3.2. For enhancing the Services provided. </p>
              <p>
                3.3. For more details about the nature of such communications,
                please refer to our Terms of Service. Further, your personal
                data and Sensitive Personal data may be collected and stored by
                Us for internal record.{" "}
              </p>
              <p>
                3.4. We use Your tracking information such as IP addresses, and
                or Device ID to help identify you and to gather broad
                demographic information and make further services available to
                you.{" "}
              </p>
              <p>
                3.5. We will not sell, license or trade Your personal
                information. We will not share your personal information with
                others unless they are acting under our instructions or we are
                required to do so by law.{" "}
              </p>
              <p>
                3.6. Information collected via Our server logs includes users’
                IP addresses and the pages visited; this will be used to manage
                the web system and troubleshoot problems. We also use
                third-party analytics, tracking, optimization and targeting
                tools to understand how users engage with our Platform so that
                we can improve it and cater personalized content/ads according
              ...
              <p>
                ...
                collection of said personal information, pending the fulfilment
                of which you shall not be mandated to disclose any information
                whatsoever.{" "}
              </p>
              <p>
                We will collect and use your personal information solely with
                the objective of fulfilling those purposes specified by us,
                within the scope of the consent of the individual concerned or
                as required by law. We will only retain personal information as
                long as necessary for the fulfilment of those purposes. We will
                collect personal information by lawful and fair means and with
              ...
              <p>
                <strong>5. EXTERNAL LINKS ON THE PLATFORM</strong>
              </p>
              <p>
                ...
                platforms or resources. You acknowledge and agree that We are
                not liable for any loss or damage which may be incurred by you
              ...
              <p>
                ...
                done on the site. The benefits of this are:{" "}
              </p>
              <p>
                6.1. You only need to log in once if you’re navigating secure
                areas of the site
              </p>
              <p>
                6.2. Our server can distinguish between your computer and other
              ...
              <p>
                ...
                cookies for usage, behavioural, analytics and preferences data.
                The following are the different types of cookies used on the
                Website:{" "}
              </p>
              <p>
                6.2.a. Authentication cookies: To identify the user and share
                the content that he or she requested.{" "}
              </p>
              <p>
                6.2.b. Functionality cookies: For the customized user experience
                and resuming past course progress.{" "}
              </p>
              <p>
                6.2.c. Tracking, optimization, and targeting cookies: To capture
                usage metric on the device,operating system, browser, etc. To
                capture behavioural metrics for better content delivery. To
                cater and suggest the most suited products and services.{" "}
              </p>
              <p>
              ...
              <p>
                7.1. The right to request a copy of your personal data which we
                hold about you;{" "}
              </p>
              <p>
                7.2. The right to request for any correction to any personal
                data if it is found to be inaccurate or out of date;{" "}
              </p>
              <p>
                7.3. The right to withdraw Your consent to the processing at any
                time;
              </p>
              <p>
                7.4. The right to object to the processing of personal data;
              </p>
              <p>
                7.5. The right to lodge a complaint with a supervisory
                authority.{" "}
              </p>
              <p>
                7.6. The right to obtain information as to whether personal data
                are transferred to a third country or to an international
                organization.{" "}
              </p>
              <p>
                Where you hold an account with any of our services, you are
                entitled to a copy of all personal data which we hold in
                relation to you. You are also entitled to request that we
              ...
              <p>
                ...
                third party or use your email address for unsolicited mail. Any
              ...
              <p>
                <strong>9. OTHER INFORMATION COLLECTORS</strong>
              </p>
              <p>
                ...
                do not control the privacy policies of third parties, you are
                subject to ask questions before you disclose your personal
                information to others.{" "}
              </p>
              <p>
                <strong>10. OUR DISCLOSURE OF YOUR INFORMATION</strong>
              </p>
              <p>
                10.1. We may host surveys for survey creators for our platform
                who are the owners and users of your survey responses. We do not
                own or sell your responses. Anything you expressly disclose in
                your responses will be disclosed to survey creators. Please
                contact the survey creator directly to better understand how
                they might share your survey responses.{" "}
              </p>
              <p>
                10.2. Information collected will not be considered as sensitive
                if it is freely available and accessible in the public domain or
                is furnished under the Right to Information Act, 2005, any rules
                made thereunder or any other law for the time being in force.{" "}
              </p>
              <p>
                10.3. Due to the existing regulatory environment, we cannot
                ...
                disclose information to the government, law enforcement agencies
                or third parties. Therefore, although we use industry-standard
                ...
                or private communications would always remain private. We do
                however assure you that any and all disclosure of your
                personally identifiable information shall be personally
                intimated to you through an email sent to your provided email
                address.{" "}
              </p>
              <p>
                10.4. As a matter of policy, we do not sell or rent any
                personally identifiable information about you to any third
                party. However, the following describes some of the ways that
                your personally identifiable information may be disclosed:{" "}
              </p>
              <p>
                10.4.a. External Service Providers: There may be a number of
                services offered by external service providers that help you use
                our Platform. If you choose to use these optional services, and
                in the course of doing so, disclose information to the external
              ...
              <p>
                10.4.b. Law and Order: We cooperate with law enforcement
              ...
              <p>
                ...
                information we are holding on you is incorrect or incomplete, or
                to remove your profile so that others cannot view it, the User
                needs to remediate, and promptly correct any such incorrect
                information.
              </p>
              <p>
                <strong>12. CONTROL OF YOUR PASSWORD </strong>
              </p>
              <p>
              ...
              <p>
                ...
                password to any third party. You are responsible for all actions
                taken with your login information and password, including fees.
                ...
                you should immediately change your password. You agree to notify
                us immediately if you suspect any consistent unauthorized use of
                your account or access to your password even after changing it.{" "}
              </p>
              <p>
                <strong>13. SECURITY</strong>
              </p>
              <p>
              ...
              <p>
                ...
                system is impenetrable. Our Company cannot guarantee the
                security of our database, nor can we guarantee that information
                you provide won’t be intercepted while being transmitted to the
              ...
              <p>
                ...
                information and will always be at the Platform. Any amendments
                to this Policy shall be deemed as accepted by the User on their
                continued use of the Platform.{" "}
              </p>
              <p>
                <strong>16. AUTOMATED DECISION MAKING</strong>
              </p>
              <p>
              ...
              <p>
                ...
                your data with us for any or all our products & services at any
                time, please email to homentorindia@gmail.com{" "}
              </p>
              <p>
              ...
              <p>
                ...
                policy, you should contact us by sending an e-mail to please
                email to homentorindia@gmail.com{" "}
              </p>
            </div>
          </div>
        </div>
