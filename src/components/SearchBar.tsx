  ...
  return (
    <div className="">
          <div className="relative flex  flex-wrap items-center ">
              ...
              <span
                  className="absolute input-group-text flex items-center whitespace-nowrap rounded px-4 py-1 text-center text-base font-normal text-neutral-700 dark:text-neutral-200"
                  id="basic-addon2">
                  <svg
