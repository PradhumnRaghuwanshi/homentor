      ...
      <div className="container">
        <div className="row">
          <div className="col-12 py-3 ">
            ...
            https://homentor.onrender.com/ (Website’), including the related
            mobile site (hereinafter referred to as ‘Platform’). The Platform is
            owned by WEBBOLSTER Private Limited, a company incorporated under
            the Companies Act, 1956 with its Address- 2 - Scheme No. 54, PU-4,
            Vijay Nagar, Indore - 452010, MP, Here in after referred to as
            ‘Platform Owner’, ‘we’, ‘us’, ‘our’). Your use of the platform and
            services and tools is governed by the following terms and conditions
            ...
            the policies that are applicable to the platform for such
            transactions. By mere use of the Platform, You shall be contracting
            with the platform owner, and these terms and conditions, including
            the policies, constitute your binding obligations, with the platform
            owner. These Terms of Use relate to your use of our website, goods
            (as applicable), or services (as applicable) (collectively,
            ‘Services’). Any terms and conditions proposed by You that are in
            addition to or that conflict with these Terms of Use are expressly
            ...
            interest in its contents. The contents include and are not limited
            ...
            owner for the services. You shall indemnify and hold harmless
            Platform Owner, its affiliates, group companies (as applicable) and
            their respective officers, directors, agents, and employees, from
            any claim or demand, or actions, including reasonable attorney’s
            fees, made by any third party or penalty imposed due to or arising
            out of Your breach of this Terms of Use, privacy Policy, and other
            ...
            third party. Not with standing anything contained in these Terms of
            Use, the parties shall not be liable for any failure to perform an
            obligation under these Terms if performance is prevented or delayed
            by a force majeure event. These Terms and any dispute or claim
            relating to it, or its enforceability, shall be governed by and
            ...
            exclusive jurisdiction of the courts of MP. All concerns or
