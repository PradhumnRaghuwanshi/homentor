        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-gray-600">
              Connecting students with verified home tutors and subject mentors for personalized learning experiences.
            </p>
            <div className="space-y-3">
              <div className="flex items-center">
                <Mail className="h-5 w-5 text-homentor-blue mr-2" />
                <a href="mailto:contact@homentor.com" className="text-gray-700 hover:text-homentor-blue transition-colors">contact@homentor.com</a>
              </div>
              <div className="flex items-center">
                <Phone className="h-5 w-5 text-homentor-blue mr-2" />
                <a href="tel:+11234567890" className="text-gray-700 hover:text-homentor-blue transition-colors">+1 (123) 456-7890</a>
              </div>
              <div className="flex items-center">
            ...
            <div className="flex space-x-4 pt-2">
              <a href="#" className="bg-homentor-lightBlue p-2 rounded-full text-homentor-blue hover:bg-homentor-blue hover:text-white transition-all">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/mentors" className="text-gray-600 hover:text-homentor-blue transition-colors">
                  Find a Mentor
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/refund" className="text-gray-600 hover:text-homentor-blue transition-colors">
                  Refund Policy
                </Link>
              </li>
            </ul>
